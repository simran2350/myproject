	   ...
	   <!--/. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="waves-effect waves-dark" href="/staff"><i class="fa fa-dashboard"></i> Staff Dashboard</a>
                    </li>
                    <li>
                        <a class="active-menu waves-effect waves-dark" href="/email"><i class="fa fa-dashboard"></i> Email </a>
                    </li>
		...
		<div id="page-wrapper">
		  <div class="header"> 
			...
			<a href="/emailshow" class="btn  btn-primary"> Show Results </a>		 
			...
			<a href="/staff" class="btn  btn-primary"> Send Email </a>		 
